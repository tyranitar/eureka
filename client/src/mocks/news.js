...
export default {
    articles: [{
        imageUrl: getPublicUrl('/images/entrepreneurship.jpg'),
        ...
        imageUrl: getPublicUrl('/images/institute_of_tech.jpg'),
        ...
        imageUrl: getPublicUrl('/images/jack_conte.jpg'),
    ...
    careers: [{
        imageUrl: getPublicUrl('/images/software_developer.jpg'),
        href: '/career/186',
        title: 'Software Developer',
        subtitle: `${ _.sample(loremIpsum).slice(0, 64) }...`,
    }, {
        imageUrl: getPublicUrl('/images/web_designer.jpg'),
        href: '/career/216',
        title: 'Website Designer',
        subtitle: `${ _.sample(loremIpsum).slice(0, 64) }...`,
    }, {
        imageUrl: getPublicUrl('/images/real_estate_agent.jpg'),
        href: '/career/173',
